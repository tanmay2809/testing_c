...
interface DeleteProps {
  ...
  setSelectedCard: SubcategoryItem | undefined;
  category: string;
}

const SubCategoryDeleteModal: React.FC<DeleteProps> = ({
  setModal,
  setSelectedCard,
  category,
}) => {
  ...
  const handleDelete = () => {
    ...
    let data = JSON.stringify({
      subcategory: setSelectedCard?._id,
    });

    let config = {
      method: "delete",
      maxBodyLength: Infinity,
      url: `${baseUrl}/api/deleteSubCategory/${category}`,
      headers: {
