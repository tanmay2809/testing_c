...
const Navbar = () => {
  ...
  return (
    <div className=" fixed bg-white  z-50 w-full h-[70px] flex justify-between items-center px-[1.5rem] border-b shadow-xl py-[.5rem] shadow-[#00000026]">
        {/* logo */}
        <img
        ...
        <div className="flex items-center justify-evenly w-[25%]  ">
            ...
            <p className="w-[1.5px] bg-[#0000004F] h-10 ml-6  "></p>
             ...
             <img onClick={handlefram} src={logo1} className="size-24  object-cover cursor-pointer" alt="logo1" />
