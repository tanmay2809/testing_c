          ...
          <div className="w-full px-6 py-4 bg-[#F1F7FF]">
            <div className="w-full flex flex-row justify-between">
              ...
              <div className="w-fit h-fit">
                <button className="w-[150px] flex flex-row justify-center items-center gap-2 bg-[#004AAD] text-white px-1 py-2 text-lg font-[500] rounded-[8px]">
                  Upgrade
                </button>
                <svg
            ...
            <div className="bg-white rounded-xl flex flex-row flex-wrap justify-between w-full h-fit p-[1.5rem]">
              <div className="flex flex-col">
                <p className="text-[18px] text-[#616161] font-[400]">
                  Subscription Period
                </p>
                <h1 className="text-lg font-semibold">15 Days</h1>
              </div>
              <div className="flex flex-col">
                <p className="text-[18px] text-[#616161] font-[400]">
                  Starting Date
                </p>
                <h1 className="text-lg font-semibold">01-03-2023</h1>
              </div>
              <div className="flex flex-col">
                <p className="text-[18px] text-[#616161] font-[400]">
                  Next Billing Date
                </p>
                <h1 className="text-lg font-semibold">15-03-2023</h1>
              </div>
              <div className="flex flex-col">
                <p className="text-[18px] text-[#616161] font-[400]">
                  Payment status
              ...
              <div className="flex flex-col">
                ...
                <h1 className="text-lg font-semibold">
                  <span>Trail Period</span> (15 Days)
                </h1>
              </div>
            </div>
          </div>
